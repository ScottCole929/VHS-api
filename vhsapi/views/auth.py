...
def register_user(request):
    ...
    new_rare_user = RareUser()
    new_rare_user.user_id = new_user.id
    new_rare_user.street_address = request.data.get('street_address')
    new_rare_user.city = request.data.get('city')
    new_rare_user.state = request.data.get('state')
    new_rare_user.zip_code = request.data.get('zip_code')
